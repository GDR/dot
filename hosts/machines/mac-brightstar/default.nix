  ...
  nix.buildMachines = [
    {
      ...
      sshUser = "dgarifullin"; # daemon connects as this user
      sshKey = "/etc/nix/brightstar-nixd_id_ed25519"; # key generated by root, authorized via charon-key (GitHub: mac-brightstar-nixd)
      system = "x86_64-linux";
      protocol = "ssh-ng";
      maxJobs = 8;
      speedFactor = 2;
